...
public class GhostsNotEdibleAndMsPacManFarPPill implements Transition {

	GHOST ghost;
	public GhostsNotEdibleAndMsPacManFarPPill(GHOST ghost) {
		super();
		this.ghost = ghost;
	}
	...
	public boolean evaluate(Input in) {
		...
		MsPacManNearPPillTransition near = new MsPacManNearPPillTransition();
