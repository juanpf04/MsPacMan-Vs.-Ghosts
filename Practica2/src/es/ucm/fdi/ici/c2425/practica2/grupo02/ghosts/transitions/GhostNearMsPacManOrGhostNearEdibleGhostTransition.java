...
public class GhostNearMsPacManOrGhostNearEdibleGhostTransition implements Transition  {

	GHOST ghost;
	public GhostNearMsPacManOrGhostNearEdibleGhostTransition(GHOST ghost) {
		super();
		this.ghost = ghost;
	}
