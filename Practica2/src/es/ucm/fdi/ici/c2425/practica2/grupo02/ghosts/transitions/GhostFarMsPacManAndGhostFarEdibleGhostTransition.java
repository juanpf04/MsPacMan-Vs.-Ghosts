...
public class GhostFarMsPacManAndGhostFarEdibleGhostTransition implements Transition  {

	GHOST ghost;
	public GhostFarMsPacManAndGhostFarEdibleGhostTransition(GHOST ghost) {
		super();
		this.ghost = ghost;
	}
